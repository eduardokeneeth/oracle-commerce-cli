...
program
  ...
  .option(
    "-e, --env <operation>",
    "start the environment manager [change|config|current]"
  )
  .option(
    "-t, --transfer <path>",
    "transfer widgets between current and target environment"
  )
  .option(
    "-x, --sse <operation>",
    "transfer SSE between current and target environment"
  )
